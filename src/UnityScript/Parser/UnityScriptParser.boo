...
class UnityScriptParser(antlr.LLkParser):
	...
	public def attribute_parameter_value() as Expression : //throws RecognitionException, TokenStreamException
		...
		try:     // for error handling
			...
			if ((_givenValue == INT)
				...
				if ((LA(1)==ID) and (tokenSet_7_.member(cast(int, LA(2))))):
					e=attribute_parameter_value_bitwise_expression()
				elif ((tokenSet_8_.member(cast(int, LA(1)))) and (tokenSet_9_.member(cast(int, LA(2))))): // line 2102
					e=typeof_expression()
				else:
					raise NoViableAltException(LT(1), getFilename())
		except ex as RecognitionException:
	...
	public def typeof_expression() as Expression : //throws RecognitionException, TokenStreamException
		...
		try:     // for error handling
			...
			if ((_givenValue == TYPEOF)): // 1831
				t = LT(1)
				match(TYPEOF)
				if ((LA(1)==LPAREN) and (tokenSet_12_.member(cast(int, LA(2))))):
					match(LPAREN)
					arg=expression()
					match(RPAREN)
				elif ((tokenSet_12_.member(cast(int, LA(1)))) and (tokenSet_11_.member(cast(int, LA(2))))): // line 2102
					arg=expression()
				else:
					raise NoViableAltException(LT(1), getFilename())
				if 0 == inputState.guessing:
			...
			if ((LA(1)==LPAREN) and (tokenSet_18_.member(cast(int, LA(2))))):
				...
				if ((_givenValue == FALSE)
					...
					pass // 947
						...
						raise NoViableAltException(LT(1), getFilename())
				match(RPAREN)
			elif ((tokenSet_6_.member(cast(int, LA(1)))) and (tokenSet_19_.member(cast(int, LA(2))))): // line 2102
				pass // 947
			else:
				raise NoViableAltException(LT(1), getFilename())
		except ex as RecognitionException:
	...
	public def class_declaration(
		...
		try:     // for error handling
			...
			match(LBRACE)
			while true:
				if ((tokenSet_21_.member(cast(int, LA(1))))):
					if 0 == inputState.guessing:
					...
					if ((_givenValue == AT)): // 1831
						...
						pass // 947
							...
							raise NoViableAltException(LT(1), getFilename())
					if ((tokenSet_22_.member(cast(int, LA(1)))) and (tokenSet_23_.member(cast(int, LA(2))))):
						mod=modifiers()
					elif ((LA(1)==FUNCTION or LA(1)==VAR) and (LA(2)==GET or LA(2)==SET or LA(2)==ID)): // line 2102
						pass // 947
					else:
						raise NoViableAltException(LT(1), getFilename())
					_givenValue  = LA(1)
	...
	public def modifiers() as TypeMemberModifiers : //throws RecognitionException, TokenStreamException
		...
		try:     // for error handling
			while true:
				_givenValue  = LA(1)
				if ((_givenValue == VIRTUAL)): // 1831
					match(VIRTUAL)
					if 0 == inputState.guessing:
						m |= TypeMemberModifiers.Virtual 
	...
	public def function_declaration(
		parent as TypeDefinition 
	) as void: //throws RecognitionException, TokenStreamException
	...
	public def for_statement(
		...
		try:     // for error handling
			...
			match(FOR)
			match(LPAREN)
			synPredMatched123 as bool = false
	...
	public def if_statement(
		...
		try:     // for error handling
			...
			if 0 == inputState.guessing:
				...
				container.Add(s)
			compound_or_single_stmt(b)
			if ((LA(1)==ELSE) and (tokenSet_33_.member(cast(int, LA(2))))):
				et = LT(1)
				match(ELSE)
				if 0 == inputState.guessing:
					b = s.FalseBlock = Block(ToLexicalInfo(et)) 
				compound_or_single_stmt(b)
			elif ((tokenSet_30_.member(cast(int, LA(1)))) and (tokenSet_11_.member(cast(int, LA(2))))): // line 2102
				pass // 947
			else:
				raise NoViableAltException(LT(1), getFilename())
		except ex as RecognitionException:
		...
		try:     // for error handling
			...
			if ((_givenValue == TRY)): // 1831
				...
				while true:
					...
					++_cnt148
				:_loop148_breakloop
				if ((LA(1)==FINALLY) and (tokenSet_33_.member(cast(int, LA(2))))):
					finally_block(s)
				elif ((tokenSet_30_.member(cast(int, LA(1)))) and (tokenSet_11_.member(cast(int, LA(2))))): // line 2102
					pass // 947
				else:
		...
		try:     // for error handling
			...
			while true:
				if ((LA(1)==CASE)):
					...
					_cnt137 as int = 0
					while true:
						if ((tokenSet_33_.member(cast(int, LA(1))))):
							statement(itemBlock)
						else:
							if (_cnt137 >= 1):
	...
	public def yield_statement(
		...
		try:     // for error handling
			yt = LT(1)
			match(YIELD)
			if ((tokenSet_12_.member(cast(int, LA(1)))) and (tokenSet_34_.member(cast(int, LA(2))))):
				e=expression()
			elif ((tokenSet_30_.member(cast(int, LA(1)))) and (tokenSet_11_.member(cast(int, LA(2))))): // line 2102
				pass // 947
			else:
	...
	public def eos() as void: //throws RecognitionException, TokenStreamException
		...
		try:     // for error handling
			if ((LA(1)==EOS) and (tokenSet_35_.member(cast(int, LA(2))))):
				_cnt44 as int = 0
				while true:
					if ((LA(1)==EOS) and (tokenSet_35_.member(cast(int, LA(2))))):
						match(EOS)
					...
					++_cnt44
				:_loop44_breakloop
			elif ((tokenSet_35_.member(cast(int, LA(1)))) and (tokenSet_36_.member(cast(int, LA(2))))): // line 2102
				if 0 == inputState.guessing:
					SemicolonExpected() 
			else:
				raise NoViableAltException(LT(1), getFilename())
	...
	public def compound_or_single_stmt(
		...
		try:     // for error handling
			if ((LA(1)==LBRACE) and (tokenSet_44_.member(cast(int, LA(2))))):
				compound_statement(b)
			elif ((tokenSet_33_.member(cast(int, LA(1)))) and (tokenSet_45_.member(cast(int, LA(2))))): // line 2102
				statement(b)
			else:
				raise NoViableAltException(LT(1), getFilename())
		except ex as RecognitionException:
	...
	public def conditional_expression() as Expression : //throws RecognitionException, TokenStreamException
		...
		try:     // for error handling
			...
			if ((LA(1)==QUESTION_MARK) and (tokenSet_12_.member(cast(int, LA(2))))):
				qm = LT(1)
				match(QUESTION_MARK)
			...
			elif ((tokenSet_11_.member(cast(int, LA(1)))) and (tokenSet_48_.member(cast(int, LA(2))))): // line 2102
				pass // 947
			else:
				raise NoViableAltException(LT(1), getFilename())
		except ex as RecognitionException:
	...
	public def sum() as Expression : //throws RecognitionException, TokenStreamException
		...
		try:     // for error handling
			e=term()
			while true:
				if ((tokenSet_49_.member(cast(int, LA(1)))) and (tokenSet_12_.member(cast(int, LA(2))))):
					_givenValue  = LA(1)
	...
	public def new_expression() as Expression : //throws RecognitionException, TokenStreamException
		...
		try:     // for error handling
			synPredMatched177 as bool = false
	...
	public def atom() as Expression : //throws RecognitionException, TokenStreamException
		...
		try:     // for error handling
			...
			if ((_givenValue == FALSE)
				...
				elif ((LA(1)==ID) and (tokenSet_11_.member(cast(int, LA(2))))): // line 2102
					e=simple_reference_expression()
				elif ((LA(1)==LPAREN) and (tokenSet_12_.member(cast(int, LA(2))))): // line 2102
					e=paren_expression()
				elif ((tokenSet_8_.member(cast(int, LA(1)))) and (tokenSet_11_.member(cast(int, LA(2))))): // line 2102
					e=typeof_expression()
				else:
					raise NoViableAltException(LT(1), getFilename())
		except ex as RecognitionException:
	...
	public def logical_expression() as Expression : //throws RecognitionException, TokenStreamException
		...
		try:     // for error handling
			e=boolean_term()
			while true:
				if ((LA(1)==LOGICAL_OR) and (tokenSet_12_.member(cast(int, LA(2))))):
					op = LT(1)
					match(LOGICAL_OR)
					rhs=boolean_term()
					if 0 == inputState.guessing:
	...
	public def boolean_term() as Expression : //throws RecognitionException, TokenStreamException
		...
		try:     // for error handling
			...
			while true:
				if ((LA(1)==LOGICAL_AND) and (tokenSet_12_.member(cast(int, LA(2))))):
					op = LT(1)
					match(LOGICAL_AND)
	...
	public def comparison_expression() as Expression : //throws RecognitionException, TokenStreamException
		...
		try:     // for error handling
			e=sum()
			while true:
				if ((tokenSet_52_.member(cast(int, LA(1)))) and (tokenSet_53_.member(cast(int, LA(2))))):
					_givenValue  = LA(1)
	...
	public def term() as Expression : //throws RecognitionException, TokenStreamException
		...
		try:     // for error handling
			e=factor()
			while true:
				if ((LA(1)==MODULUS or LA(1)==MULTIPLY or LA(1)==DIVISION) and (tokenSet_12_.member(cast(int, LA(2))))):
					_givenValue  = LA(1)
	...
	public def factor() as Expression : //throws RecognitionException, TokenStreamException
		...
		try:     // for error handling
			e=bitwise_or()
			while true:
				if ((LA(1)==SHIFT_LEFT or LA(1)==SHIFT_RIGHT) and (tokenSet_12_.member(cast(int, LA(2))))):
					_givenValue  = LA(1)
	...
	public def bitwise_or() as Expression : //throws RecognitionException, TokenStreamException
		...
		try:     // for error handling
			e=bitwise_xor()
			while true:
				if ((LA(1)==BITWISE_OR) and (tokenSet_12_.member(cast(int, LA(2))))):
					token = LT(1)
					match(BITWISE_OR)
					if 0 == inputState.guessing:
	...
	public def bitwise_xor() as Expression : //throws RecognitionException, TokenStreamException
		...
		try:     // for error handling
			e=bitwise_and()
			while true:
				if ((LA(1)==BITWISE_XOR) and (tokenSet_12_.member(cast(int, LA(2))))):
					token = LT(1)
					match(BITWISE_XOR)
					if 0 == inputState.guessing:
	...
	public def bitwise_and() as Expression : //throws RecognitionException, TokenStreamException
		...
		try:     // for error handling
			e=unary_expression()
			while true:
				if ((LA(1)==BITWISE_AND) and (tokenSet_12_.member(cast(int, LA(2))))):
					token = LT(1)
					match(BITWISE_AND)
					if 0 == inputState.guessing:
	...
	public def unary_expression() as Expression : //throws RecognitionException, TokenStreamException
		...
		try:     // for error handling
			...
			if ((_givenValue == NOT)
				...
				e=slicing_expression()
				if ((LA(1)==INCREMENT) and (tokenSet_11_.member(cast(int, LA(2))))):
					postinc = LT(1)
					match(INCREMENT)
					if 0 == inputState.guessing:
						op = postinc; uOperator = UnaryOperatorType.PostIncrement; 
				elif ((LA(1)==DECREMENT) and (tokenSet_11_.member(cast(int, LA(2))))): // line 2102
					preinc = LT(1)
					match(DECREMENT)
					if 0 == inputState.guessing:
		...
		try:     // for error handling
			...
			while true:
				if ((LA(1)==LBRACK) and (tokenSet_54_.member(cast(int, LA(2))))):
					...
					if 0 == inputState.guessing:
						e = MemberReferenceExpression(ToLexicalInfo(memberName), Target: e, Name: memberName.getText())
				elif ((LA(1)==LPAREN) and (tokenSet_55_.member(cast(int, LA(2))))): // line 2102
					lparen = LT(1)
					match(LPAREN)
					if 0 == inputState.guessing:
