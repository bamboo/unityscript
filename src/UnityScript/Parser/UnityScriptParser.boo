...
class UnityScriptParser(antlr.LLkParser):
	...
	private static def mk_tokenSet_40_() as (long):
		data = (72066480056901632L, 536870912L, 0L, 0L, )
		return data
