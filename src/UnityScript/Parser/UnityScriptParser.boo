...
class UnityScriptParser(antlr.LLkParser):
	...
	public def statement(
		...
		try:     // for error handling
			...
			if ((_givenValue == DO)
				...
				_cnt109 as int = 0
				while true:
					if ((LA(1)==EOS) and (tokenSet_13_.member(cast(int, LA(2))))):
						match(EOS)
					else:
						if (_cnt109 >= 1):
	...
	public def attribute_constructor() as Boo.Lang.Compiler.Ast.Attribute : //throws RecognitionException, TokenStreamException
		...
		try:     // for error handling
			...
			if ((LA(1)==LPAREN) and (tokenSet_20_.member(cast(int, LA(2))))):
				match(LPAREN)
				_givenValue  = LA(1)
				if ((_givenValue == FALSE)
					 or (_givenValue ==FUNCTION)
		...
		try:     // for error handling
			...
			while true:
				if ((tokenSet_27_.member(cast(int, LA(1))))):
					...
					elif ((tokenSet_24_.member(cast(int, LA(1)))) and (tokenSet_30_.member(cast(int, LA(2))))): // line 2102
						pass // 947
					else:
						raise NoViableAltException(LT(1), getFilename())
					_givenValue  = LA(1)
			...
			while true:
				if ((LA(1)==EOS) and (tokenSet_31_.member(cast(int, LA(2))))):
					match(EOS)
				else:
	...
	public def compound_statement(
		...
		try:     // for error handling
			block(b)
			while true:
				if ((LA(1)==EOS) and (tokenSet_40_.member(cast(int, LA(2))))):
					match(EOS)
				else:
	...
	public def compound_or_single_stmt(
		...
		try:     // for error handling
			if ((LA(1)==LBRACE) and (tokenSet_41_.member(cast(int, LA(2))))):
				compound_statement(b)
			elif ((tokenSet_2_.member(cast(int, LA(1)))) and (tokenSet_42_.member(cast(int, LA(2))))): // line 2102
				statement(b)
			else:
				raise NoViableAltException(LT(1), getFilename())
		except ex as RecognitionException:
	...
	public def for_statement(
		...
		try:     // for error handling
			...
			match(FOR)
			match(LPAREN)
			synPredMatched125 as bool = false
			if ((tokenSet_43_.member(cast(int, LA(1)))) and (tokenSet_44_.member(cast(int, LA(2))))):
				_m125 as int = mark()
			...
			elif ((tokenSet_45_.member(cast(int, LA(1)))) and (tokenSet_46_.member(cast(int, LA(2))))): // line 2102
	...
	public def if_statement(
		...
		try:     // for error handling
			...
			if ((LA(1)==ELSE) and (tokenSet_2_.member(cast(int, LA(2))))):
				...
				compound_or_single_stmt(b)
			elif ((tokenSet_13_.member(cast(int, LA(1)))) and (tokenSet_18_.member(cast(int, LA(2))))): // line 2102
				pass // 947
			else:
				raise NoViableAltException(LT(1), getFilename())
		except ex as RecognitionException:
	...
	public def yield_statement(
		...
		try:     // for error handling
			yt = LT(1)
			match(YIELD)
			if ((tokenSet_14_.member(cast(int, LA(1)))) and (tokenSet_47_.member(cast(int, LA(2))))):
				e=expression()
			elif ((tokenSet_13_.member(cast(int, LA(1)))) and (tokenSet_18_.member(cast(int, LA(2))))): // line 2102
				pass // 947
			else:
	...
	public def conditional_expression() as Expression : //throws RecognitionException, TokenStreamException
		...
		try:     // for error handling
			e=logical_or()
			if ((LA(1)==QUESTION_MARK) and (tokenSet_14_.member(cast(int, LA(2))))):
				qm = LT(1)
				match(QUESTION_MARK)
			...
			elif ((tokenSet_18_.member(cast(int, LA(1)))) and (tokenSet_50_.member(cast(int, LA(2))))): // line 2102
				pass // 947
			else:
				raise NoViableAltException(LT(1), getFilename())
		except ex as RecognitionException:
	...
	public def sum() as Expression : //throws RecognitionException, TokenStreamException
		...
		try:     // for error handling
			e=term()
			while true:
				if ((LA(1)==ADD or LA(1)==SUBTRACT) and (tokenSet_14_.member(cast(int, LA(2))))):
					_givenValue  = LA(1)
	...
	public def new_expression() as Expression : //throws RecognitionException, TokenStreamException
		...
		try:     // for error handling
			synPredMatched184 as bool = false
	...
	public def atom() as Expression : //throws RecognitionException, TokenStreamException
		...
		try:     // for error handling
			...
			if ((_givenValue == FALSE)
				...
				elif ((LA(1)==ID) and (tokenSet_18_.member(cast(int, LA(2))))): // line 2102
					e=simple_reference_expression()
				elif ((LA(1)==LPAREN) and (tokenSet_14_.member(cast(int, LA(2))))): // line 2102
					e=paren_expression()
				elif ((tokenSet_52_.member(cast(int, LA(1)))) and (tokenSet_18_.member(cast(int, LA(2))))): // line 2102
					e=typeof_expression()
				else:
					raise NoViableAltException(LT(1), getFilename())
		except ex as RecognitionException:
	...
	public def typeof_expression() as Expression : //throws RecognitionException, TokenStreamException
		...
		try:     // for error handling
			...
			if ((_givenValue == TYPEOF)): // 1831
				t = LT(1)
				match(TYPEOF)
				if ((LA(1)==LPAREN) and (tokenSet_14_.member(cast(int, LA(2))))):
					match(LPAREN)
					arg=expression()
					match(RPAREN)
				elif ((tokenSet_14_.member(cast(int, LA(1)))) and (tokenSet_18_.member(cast(int, LA(2))))): // line 2102
		...
		try:     // for error handling
			...
			while true:
				if ((LA(1)==LBRACK) and (tokenSet_54_.member(cast(int, LA(2))))):
					...
					match(DOT)
					e=member_reference_expression(e)
				elif ((LA(1)==LPAREN) and (tokenSet_20_.member(cast(int, LA(2))))): // line 2102
					lparen = LT(1)
					match(LPAREN)
					if 0 == inputState.guessing:
	...
	public def postfix_unary_expression() as Expression : //throws RecognitionException, TokenStreamException
		...
		try:     // for error handling
			...
			if ((LA(1)==INCREMENT) and (tokenSet_18_.member(cast(int, LA(2))))):
				postinc = LT(1)
				match(INCREMENT)
				if 0 == inputState.guessing:
					token = postinc; operator = UnaryOperatorType.PostIncrement; 
			elif ((LA(1)==DECREMENT) and (tokenSet_18_.member(cast(int, LA(2))))): // line 2102
				preinc = LT(1)
				match(DECREMENT)
				if 0 == inputState.guessing:
	...
	public def term() as Expression : //throws RecognitionException, TokenStreamException
		...
		try:     // for error handling
			e=unary_expression()
			while true:
				if ((LA(1)==MODULUS or LA(1)==MULTIPLY or LA(1)==DIVISION) and (tokenSet_14_.member(cast(int, LA(2))))):
					_givenValue  = LA(1)
	...
	public def shift() as Expression : //throws RecognitionException, TokenStreamException
		...
		try:     // for error handling
			e=sum()
			while true:
				if ((LA(1)==SHIFT_LEFT or LA(1)==SHIFT_RIGHT) and (tokenSet_14_.member(cast(int, LA(2))))):
					_givenValue  = LA(1)
	...
	public def comparison() as Expression : //throws RecognitionException, TokenStreamException
		...
		try:     // for error handling
			e=shift()
			while true:
				if ((tokenSet_56_.member(cast(int, LA(1)))) and (tokenSet_14_.member(cast(int, LA(2))))):
					_givenValue  = LA(1)
					if ((_givenValue == IN)
	...
	public def equality() as Expression : //throws RecognitionException, TokenStreamException
		...
		try:     // for error handling
			e=comparison()
			while true:
				if ((tokenSet_57_.member(cast(int, LA(1)))) and (tokenSet_14_.member(cast(int, LA(2))))):
					_givenValue  = LA(1)
	...
	public def bitwise_and() as Expression : //throws RecognitionException, TokenStreamException
		...
		try:     // for error handling
			e=equality()
			while true:
				if ((LA(1)==BITWISE_AND) and (tokenSet_14_.member(cast(int, LA(2))))):
					token = LT(1)
					match(BITWISE_AND)
					if 0 == inputState.guessing:
	...
	public def bitwise_xor() as Expression : //throws RecognitionException, TokenStreamException
		...
		try:     // for error handling
			e=bitwise_and()
			while true:
				if ((LA(1)==BITWISE_XOR) and (tokenSet_14_.member(cast(int, LA(2))))):
					token = LT(1)
					match(BITWISE_XOR)
					if 0 == inputState.guessing:
	...
	public def bitwise_or() as Expression : //throws RecognitionException, TokenStreamException
		...
		try:     // for error handling
			e=bitwise_xor()
			while true:
				if ((LA(1)==BITWISE_OR) and (tokenSet_14_.member(cast(int, LA(2))))):
					token = LT(1)
					match(BITWISE_OR)
					if 0 == inputState.guessing:
	...
	public def logical_and() as Expression : //throws RecognitionException, TokenStreamException
		...
		try:     // for error handling
			e=bitwise_or()
			while true:
				if ((LA(1)==LOGICAL_AND) and (tokenSet_14_.member(cast(int, LA(2))))):
					op = LT(1)
					match(LOGICAL_AND)
					rhs=bitwise_or()
					if 0 == inputState.guessing:
	...
	public def logical_or() as Expression : //throws RecognitionException, TokenStreamException
		...
		try:     // for error handling
			e=logical_and()
			while true:
				if ((LA(1)==LOGICAL_OR) and (tokenSet_14_.member(cast(int, LA(2))))):
					op = LT(1)
					match(LOGICAL_OR)
					rhs=logical_and()
					if 0 == inputState.guessing:
	...
	public def array_literal() as Expression : //throws RecognitionException, TokenStreamException
		...
		try:     // for error handling
			lbrack = LT(1)
			match(LBRACK)
			synPredMatched294 as bool = false
			if ((tokenSet_14_.member(cast(int, LA(1)))) and (tokenSet_58_.member(cast(int, LA(2))))):
				_m294 as int = mark()
			...
			elif ((tokenSet_59_.member(cast(int, LA(1)))) and (tokenSet_18_.member(cast(int, LA(2))))): // line 2102
				if 0 == inputState.guessing:
