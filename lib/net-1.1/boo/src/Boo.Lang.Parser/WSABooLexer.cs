		...
		{
			{
				...
				{ // ( ... )+
					...
					for (;;)
					{
						...
						{
							if (_cnt570 >= 1) { goto _loop570_breakloop; } else { throw new NoViableAltForCharException(cached_LA1, getFilename(), getLine(), getColumn());; }
						}
	...
	protected void mRE_LITERAL(bool _createToken) //throws RecognitionException, CharStreamException, TokenStreamException
{
		...
		{ // ( ... )+
			...
			for (;;)
			{
				...
				{
					if (_cnt717 >= 1) { goto _loop717_breakloop; } else { throw new NoViableAltForCharException(cached_LA1, getFilename(), getLine(), getColumn());; }
				}
	...
	protected void mTRIPLE_QUOTED_STRING(bool _createToken) //throws RecognitionException, CharStreamException, TokenStreamException
{
		...
		{    // ( ... )*
			...
			{
				// nongreedy exit test
				if ((cached_LA1=='"') && (cached_LA2=='"') && (LA(3)=='"')) goto _loop664_breakloop;
