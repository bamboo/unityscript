...
";
			...
			RuntimeServices.RegisterExtensions(assembly.GetType("ArrayExtensions"));
			RuntimeServices.RegisterExtensions(assembly.GetType("StringExtensions"));
		...
		{
			return RuntimeServices.SetProperty(o != null ? o : type, name, value);
		}
		...
		{
			return RuntimeServices.GetProperty(o != null ? o : type, name);
		}
	}
}
