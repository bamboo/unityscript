...
namespace Boo.Lang.Runtime.Tests
{
	...
	public class RuntimeCoercionTestCase
	{
		...
		{	
			RuntimeServices.WithExtensions(typeof (IntegerExtensions), new RuntimeServices.CodeBlock(ImplicitConversionBlock));
		}

		private void ImplicitConversionBlock()
		{
			Assert.AreEqual(42, Coerce(new Integer(42), typeof (int)));
