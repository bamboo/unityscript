...
{	
	...
	[System.Serializable]
	public ${abstractClass} class ${node.Name}Impl : ${join(node.BaseTypes, ', ')}
	{
		public ${node.Name}Impl()
		{
		}

		public ${node.Name}Impl(LexicalInfo lexicalInfo) : base(lexicalInfo)
		{
		}
<%
...
%>
		...
		{
			visitor.On${node.Name}((${node.Name})this);
		}
<%
	end
